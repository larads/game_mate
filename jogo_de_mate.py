...
def game(a, b, c):
    k = 0
    print("\033[0;30;43mOi, me chamo teste-1011101, mas pode me chamar de Boby! ^^\033[m")
    time.sleep(1)
    ...
    if (x == "Sim" or x == "sim" or x == "SIM" or x == "s" or x == "S" or x == "SS" or x == "ss"):
        ...
        if cc == '*':
            ...
            if y == z:
                ...
                print("\033[0;30;41mBoby está ficando triste (o.o ) A resposta era: {0}\033[m".format(z))
                k = k-1
        if cc == '-':
            y = float(input("Quantos é {0} {1} {2} ? ".format(aa, cc, bb)))
            z = aa-bb
